...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            Ust ue = new Ust();
            int numero = Convert.ToInt32((Interaction.InputBox("INGRESAR UN NÚMERO PARA VER SI ES O NO ES ESPEJO")));
            int espejo = ue.esEspejo(numero);
            if (espejo == 1) {
                MessageBox.Show("EL NÚMERO: " + numero + " ES ESPEJO !!!!!");
            } else {
                MessageBox.Show("EL NÚMERO: " + numero + " NO ES ESPEJO !!!!!");
            }
        }
        ...
        {
            Ust ua = new Ust();
            int numero1 = Convert.ToInt32((Interaction.InputBox("INGRESAR UN NÚMERO PARA VER SI ES AMIGO DEL OTRO")));
            int numero2 = Convert.ToInt32((Interaction.InputBox("INGRESAR UN NÚMERO PARA VER SI ES AMIGO DEL OTRO")));
            int n1 = ua.sumaDivisores(numero1);
            int n2 = ua.sumaDivisores(numero2);
            if(numero1 == n2 && numero2 == n1)
            {
                MessageBox.Show("LOS NÚMEROS: " + numero1 + " Y " + numero2 + " SON AMIGOS!!!!!");
            }
            else
            {
                MessageBox.Show("LOS NÚMEROS: " + numero1 + " Y " + numero2 + " NO SON AMIGOS!!!!!");
